      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-6xl flex-col px-4 py-8 sm:px-10 lg:px-12">
        ...
        <section className="grid flex-1 items-center gap-8 py-10 lg:py-16">
          <div className="space-y-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8">
              ...
              <a
                className="wiggle wiggle-delay-3 wiggle-hover relative flex items-center justify-center px-12 py-3 transition-transform duration-150 hover:scale-105 active:scale-95"
                href="#gallery"
              >
                <img
                  src="/btn-gallery.svg"
        ...
        <div className="flex justify-start">
          <img
            src="/kasper.svg"
            alt=""
            className="w-[200px] sm:w-[280px] lg:w-[364px] h-auto scale-180 mb-[20px]"
          />
        </div>
        ...
        <div className="flex justify-end">
          <img
            src="/leo.svg"
            alt=""
            className="w-[200px] sm:w-[280px] lg:w-[364px] h-auto scale-180 mr-[40px] mb-[40px] mt-[60px] -z-20"
          />
        </div>
        ...
        <section className="py-10 text-center">
          <p className="font-arima mx-auto max-w-2xl px-6 text-[14px] font-[300] leading-relaxed text-jneutral opacity-90">
            Το έτος ήταν 2026...
            <br />
            Το ζευγάρι αποφάσισε ότι δεν του ταίριαζαν οι μεγάλες τελετές και
            κλέφτηκε σε μιά σεμνή, μαζεμένη τελετή υπογραφών στο Δημαρχείο της
            Ηλιούπολης.
            <br />
            Όμως δεν άντεξε... Το wedding party έπρεπε να γίνει. Φίλοι, γνωστοί
            και συνεργάτες μαζεύτηκαν να βγούνε για μπύρες, σε μία βραδιά που θα
            έμενε αξέχαστη! Οι φίλοι τους ευχήθηκαν τα καλύτερα και τους έδωσαν
            την αγάπη τους ❤️ και πολλές καλές αναμνήσεις.
          </p>
        </section>
