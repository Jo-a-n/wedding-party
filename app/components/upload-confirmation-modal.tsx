              ...
              {albumUrl ? (
                <div className="mt-3">
                  <a
                    ...
                    className="inline-flex items-center gap-2 rounded-lg bg-amber-600 px-4 py-2.5 text-[15px] font-[600] text-white shadow-sm transition-all hover:bg-amber-700 hover:shadow-md dark:bg-amber-500 dark:hover:bg-amber-400 dark:text-amber-950"
                  >
                  ...
                  <p className="mt-1.5 text-[11px] text-amber-600/70 dark:text-amber-400/60 break-all">
                    {albumUrl}
                  </p>
                </div>
              ) : (
